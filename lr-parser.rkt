  ...
  (parser
   ...
   (grammar
    ...
    (type-qualifier-list [(const) #f]
                         [(restrict) #f]
                         [(volatile) #f])
    (type-specifier [(void) (pt:type_specifier (@ 1 1) $1)]
                    [(char) (pt:type_specifier (@ 1 1) $1)]
                    [(short) (pt:type_specifier (@ 1 1) $1)]
                    ...
                    [(unsigned) (pt:type_specifier (@ 1 1) $1)]
                    [(bool) (pt:type_specifier (@ 1 1) $1)]
                    [(complex) (pt:type_specifier (@ 1 1) $1)]
